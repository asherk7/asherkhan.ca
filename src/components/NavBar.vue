  ...
  <header class="header z-40">
    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        ...
        <RouterLink to="/education" title="Education">
          <span class="lt-md:hidden">Education</span>
          <div i-ri-graduation-cap-line class="md:hidden" />
        </RouterLink>
        ...
        <a href="https://open.spotify.com/user/22cjx7umpkdnqnmjnk37n642q?si=bee38c5579cd486e" target="_blank" title="Spotify" class="lt-md:hidden">
          <div i-ri-spotify-line />
        </a>
        <ToggleTheme />
      </div>
    </nav>
